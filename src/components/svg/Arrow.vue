<template>
  <svg xmlns="http://www.w3.org/2000/svg" :fill="fill" :width="widthPx" :height="heightPx" viewBox="0 0 1024 1024">
    <path
...
export default {
  name: 'Arrow',
  props: {
    width: { default: 48, type: Number },
    height: { default: 48, type: Number },
    fill: { default: '#fff', type: String }
  },
  setup(props) {
